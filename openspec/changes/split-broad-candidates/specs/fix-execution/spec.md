...
- **WHEN** an agent runs `deepclean fix <broad-parent> --apply --verification "npm test" --json`
...
- **WHEN** an agent runs `deepclean fix <child-candidate> --apply --verification "npm test" --json`
