...
## Purpose
Define the release gates and repository hygiene required before publishing Deepclean.
## Requirements
...
The project SHALL include CI that runs typecheck, tests, build, and package smoke checks on supported Node versions.
...
- **THEN** the packed tarball is inspected for required public files and forbidden local artifacts
